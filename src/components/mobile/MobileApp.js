                ...
                <div style={{ display: "grid", gap: "10px" }}>
                        ...
                        {selectedCharacterFilters.length > 0 && (
                          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: "4px" }}>
                            <button type="button" onClick={() => setSelectedCharacterFilters([])}
                              style={{ border: "none", background: "none", color: "#2196F3", fontSize: "11px", cursor: "pointer", padding: "0", fontFamily: "'Century Gothic', 'Futura', 'Arial', sans-serif" }}>
                              Clear
                            </button>
                          </div>
                        )}
                            ...
                            {characterOptions.map((name) => {
                              ...
                              return (
                                <label key={name}
                                  ...
                                  <span style={{ fontSize: "12px", fontFamily: "'Century Gothic', 'Futura', 'Arial', sans-serif", color: "#222" }}>{name}</span>
                                </label>
                              );
                            })}
                          </div>
                  ...
                  <label style={{ display: "grid", gap: "3px", fontSize: "11px", color: "#666" }}>
                    ...
                    <select
                      ...
                      style={{ border: "1px solid #d7d7d7", borderRadius: "4px", padding: "7px 8px", fontSize: "12px", fontFamily: "'Century Gothic', 'Futura', 'Arial', sans-serif" }}
                    >
                  ...
                  <div style={{ display: "grid", gap: "10px", paddingTop: "8px" }}>
                    ...
                    <label style={{ display: "grid", gap: "3px", fontSize: "11px", color: "#666", fontWeight: "bold" }}>
                      ...
                      <select value={sidesShootingDay} onChange={(e) => setSidesShootingDay(e.target.value)}
                        style={{ border: "1px solid #d7d7d7", borderRadius: "4px", padding: "7px 8px", fontSize: "12px", fontFamily: "'Century Gothic', 'Futura', 'Arial', sans-serif", fontWeight: "normal" }}>
                    ...
                    <label style={{ display: "flex", alignItems: "center", gap: "8px", cursor: "pointer" }}>
                      <input type="checkbox" checked={sidesUseCurrentDay} onChange={() => setSidesUseCurrentDay((v) => !v)}
                        style={{ accentColor: "#2196F3", width: "14px", height: "14px", flexShrink: 0 }} />
                      <span style={{ fontSize: "12px", fontFamily: "'Century Gothic', 'Futura', 'Arial', sans-serif", color: "#444" }}>Current Day / Today</span>
                    </label>
