...
function CallSheetModule({
  ...
  if (shootingDays.length === 0) {
    return (
      <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, overflow: "hidden" }}>
        ...
        {/* ── Content area ── */}
        <div style={{ flex: 1, overflowY: "auto", padding: "20px", boxSizing: "border-box", fontFamily: "'FPB Century Gothic', 'Century Gothic', 'Futura', 'Arial', sans-serif" }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, overflow: "hidden" }}>
      ...
      {/* ── Content area ── */}
      <div style={{ flex: 1, overflow: "auto", padding: "20px", fontFamily: "'FPB Century Gothic', 'Century Gothic', 'Futura', 'Arial', sans-serif", boxSizing: "border-box" }}>
        {/* Call Sheet */}
          ...
          <div style={{ display: "flex", borderBottom: "1px solid black" }}>
            <div style={{ flex: "2", padding: "8px", borderRight: "1px solid black", minHeight: "60px" }}>
              ...
              <textarea
                ...
                style={{ width: "calc(100% - 8px)", height: "40px", border: "1px solid #ccc", borderRadius: "3px", padding: "4px", fontSize: "11px", fontFamily: "'FPB Century Gothic', 'Century Gothic', 'Futura', 'Arial', sans-serif", resize: "none" }}
              />
            </div>
