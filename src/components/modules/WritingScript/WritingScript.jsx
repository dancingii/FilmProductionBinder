...
function BeatsList({ beats, onDeleteItem = null, onReorderItem = null, onOpenItem = null, onConvertItem = null, onColorItem = null, collapsedActIds = {}, onToggleAct = null, showMoodOverlay = false }) {
  ...
  return (
    <div style={{ marginLeft: "20px", flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
      <div style={{ width: "492px", border: "2px inset #ccc", backgroundColor: showMoodOverlay ? "rgba(255,255,255,0.15)" : "white", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", fontSize: "12px", overflowY: "auto", overflowX: "hidden", flex: 1 }}>
      ...
      {beatContextMenu && (
        <>
          ...
          <div style={{ position: "fixed", left: beatContextMenu.x, top: beatContextMenu.y, zIndex: 3000, backgroundColor: "white", border: "1px solid #e0e0e0", borderRadius: "6px", boxShadow: "0 4px 16px rgba(0,0,0,0.18)", minWidth: "190px", overflow: "hidden", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", fontSize: "12px" }}>
      ...
      {sceneContextMenu && (
        <>
          ...
          <div
            ...
            style={{ position: "fixed", left: sceneContextMenu.x, top: sceneContextMenu.y, zIndex: 3000, backgroundColor: "white", border: "1px solid #bbb", borderRadius: "4px", boxShadow: "0 4px 12px rgba(0,0,0,0.18)", minWidth: "142px", overflow: "hidden", padding: "4px", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", fontSize: "11px" }}
          >
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0, overflow: "hidden", boxSizing: "border-box" }}>
	          ...
	          <div style={{ flex: "0 0 8.5in", width: "8.5in", minWidth: 0, display: "flex", gap: "8px", alignItems: "center", padding: "5px 12px", boxSizing: "border-box", whiteSpace: "nowrap", overflow: "hidden" }}>
	            ...
	            <div style={{ display: "flex", alignItems: "center", gap: "6px", minWidth: 0, marginLeft: "auto" }}>
	              ...
	              <span
	                ...
	                style={{ width: "70px", minWidth: "70px", textAlign: "right", fontSize: "10px", color: getWritingDraftSaveStatusColor(writingDraftSaveStatus), fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", whiteSpace: "nowrap", overflow: "hidden", marginRight: "2px" }}
	              >
	              ...
	              <select
	                ...
	                style={{ width: "132px", padding: "5px 8px", fontSize: "12px", border: "1px solid #ccc", borderRadius: "4px", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", opacity: writingEditorElementType ? 1 : 0.55, cursor: writingEditorElementType ? "pointer" : "default" }}
	              >
	            ...
	            <div style={{ display: "flex", alignItems: "center", gap: "6px", marginLeft: "auto", flexShrink: 0 }}>
	              <div style={{ position: "relative", display: "inline-flex" }}>
	                <button
	                  ...
	                  style={{ padding: "3px 8px", minWidth: "74px", fontSize: "11px", border: `1px solid ${activeFormats.highlight ? APP_TAB_BLUE : "#ccc"}`, borderRadius: "4px", backgroundColor: activeFormats.highlight ? "#fffde7" : "#f7f7f7", color: activeFormats.highlight ? APP_TAB_BLUE : "#333", cursor: "pointer", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", whiteSpace: "nowrap" }}
	                >
	                  Highlight
	                </button>
	              ...
	              <button
	                ...
	                style={{ padding: "3px 7px", fontSize: "11px", border: `1px solid ${showSpellcheckModal ? APP_TAB_BLUE : "#ccc"}`, borderRadius: "4px", backgroundColor: showSpellcheckModal ? "#e8f0fe" : "#f7f7f7", color: showSpellcheckModal ? APP_TAB_BLUE : "#555", cursor: "pointer", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}
	              >
	                Spellcheck
	              </button>
		            </div>
		          ...
		          <div style={{ flex: "0 0 520px", width: "520px", minWidth: 0, display: "flex", gap: "8px", alignItems: "center", justifyContent: "flex-end", padding: "5px 0 5px 12px", boxSizing: "border-box" }}>
		            <div style={{ display: "flex", alignItems: "center", gap: "6px", flexShrink: 0 }}>
		              <button
		                ...
		                style={{ padding: "3px 7px", fontSize: "11px", border: "1px solid #ccc", borderRadius: "4px", backgroundColor: "#f7f7f7", color: "#555", cursor: isPdfExporting ? "default" : "pointer", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", opacity: isPdfExporting ? 0.6 : 1, whiteSpace: "nowrap" }}
		              >
		              ...
		              {!isViewOnly && (
		                <button
		                  ...
		                  style={{ padding: "3px 7px", fontSize: "11px", border: "1px solid #ccc", borderRadius: "4px", backgroundColor: "#f7f7f7", color: "#555", cursor: "pointer", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", whiteSpace: "nowrap" }}
		                >
		                  Share Script...
		                </button>
		              )}
		            </div>
            <span style={{ fontSize: "11px", color: "#555", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", whiteSpace: "nowrap", fontVariantNumeric: "tabular-nums" }}>
      ...
      {showBeatImportDialog && (
        <>
          ...
          <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "760px", maxWidth: "calc(100vw - 40px)", maxHeight: "82vh", overflow: "hidden", backgroundColor: "white", borderRadius: "8px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", zIndex: 22001, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      {selectedBeatDetail && (
        <>
          ...
          <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "640px", maxWidth: "calc(100vw - 40px)", maxHeight: "82vh", overflow: "hidden", backgroundColor: "white", borderRadius: "8px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", zIndex: 21901, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif", display: "flex", flexDirection: "column" }}>
            <div style={{ padding: "18px 20px", borderBottom: "1px solid #e5e5e5", display: "flex", justifyContent: "space-between", gap: "12px", alignItems: "center" }}>
              <div>
	      ...
	      {showMoodOverlaySettings && createPortal(
	        <>
	          ...
	          <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "480px", maxWidth: "calc(100vw - 40px)", maxHeight: "86vh", overflowY: "auto", backgroundColor: "white", borderRadius: "10px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", padding: "22px", zIndex: WRITING_OVERLAY_Z_INDEX + 1, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}>
	      ...
	      {showShareScriptModal && createPortal((() => {
	        ...
	        return (
	          <>
	            ...
	            <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "520px", maxWidth: "calc(100vw - 40px)", backgroundColor: "white", borderRadius: "10px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", padding: "22px", zIndex: WRITING_OVERLAY_Z_INDEX + 1, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}>
	            ...
	            {showShareWatermarkSettings && activeWatermarkLink && (
	              <>
	                ...
	                <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "480px", maxWidth: "calc(100vw - 40px)", maxHeight: "86vh", overflowY: "auto", backgroundColor: "white", borderRadius: "10px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", padding: "20px", zIndex: WRITING_OVERLAY_Z_INDEX + 3, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}>
	      ...
	      {showMoodOverlayDetailSettings && createPortal((() => {
	        ...
	        <>
	          ...
	          <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "500px", maxWidth: "calc(100vw - 40px)", backgroundColor: "white", borderRadius: "10px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", padding: "22px", zIndex: WRITING_OVERLAY_Z_INDEX + 1, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}>
	            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
	      ...
	      {showTitlePageSettings && createPortal(
	        <>
	          ...
	          <div style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "560px", maxWidth: "calc(100vw - 40px)", maxHeight: "86vh", overflowY: "auto", backgroundColor: "white", borderRadius: "8px", boxShadow: "0 12px 40px rgba(0,0,0,0.35)", padding: "20px", zIndex: WRITING_OVERLAY_Z_INDEX + 1, fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}>
	            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden", minWidth: 0, position: "relative", isolation: "isolate", width: "calc(8.5in + 520px)", maxWidth: "calc(8.5in + 520px)", alignSelf: "flex-start", paddingTop: "5px", boxSizing: "border-box" }}>
        ...
        <div style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column", position: "relative", zIndex: 1, backgroundColor: showMoodOverlay ? "transparent" : "white", minWidth: 0 }}>
          {/* Tab bar */}
          <div style={{ marginLeft: "20px", width: "492px", display: "flex", flexShrink: 0, gap: "6px", padding: "0 0 5px", boxSizing: "border-box", fontFamily: "'Questrial', 'Futura', 'Arial', sans-serif" }}>
